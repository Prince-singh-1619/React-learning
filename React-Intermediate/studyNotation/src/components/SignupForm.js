    ...
    <div>
        ...
        <div className="flex bg-richblack-800 p-1 gap-x-1 my-6 rounded-full max-w-max">
            <button 
                ...
                Student</button>
            <button className={`${accountType==="instuctor" ? "bg-richblack-900 text-richblack-5" : "bg-transparent text-richblack-200"} py-2 px-5 rounded-full transition-all duration-200`} 
                onClick={() => setAccountType("instuctor")}>
                Instructor</button>
        </div>
